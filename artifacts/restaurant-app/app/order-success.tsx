  ...
  return (
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { paddingTop: topInset + 12 }]}>
        <Text style={[styles.headerTitle, { color: colors.foreground }]}>Order Placed</Text>
      </View>
      ...
      <View style={styles.center}>
        ...
        <Animated.View style={{ opacity, alignItems: "center", gap: 12 }}>
          <Text style={[styles.title, { color: colors.foreground }]}>Congratulations!</Text>
          <Text style={[styles.subtitle, { color: colors.mutedForeground }]}>
            Your order has been confirmed successfully.{"\n"}We'll deliver it to you shortly.
          </Text>
          {orderId && (
            <View style={[styles.orderBadge, { backgroundColor: colors.secondary }]}>
              <Text style={[styles.orderBadgeText, { color: colors.primary }]}>Order #{orderId}</Text>
            </View>
          )}
        </Animated.View>
      </View>
      ...
      <View style={[styles.footer, { paddingBottom: bottomInset + 16 }]}>
        ...
        >
          <Text style={[styles.profileBtnText, { color: colors.foreground }]}>View Orders</Text>
        </Pressable>
      </View>
    </View>
  );
